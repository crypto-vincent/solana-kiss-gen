  ...
  instructions: {
    create: {
      ...
      accounts: [
        ...
        { name: "created", isMut: true, isSigner: true },
      ],
    },
    assign: {
      discriminator: [1, 0, 0, 0],
      args: [{ name: "owner", type: "publicKey" }],
      accounts: [{ name: "assigned", isMut: true, isSigner: true }],
    },
    transfer: {
    ...
    allocate: {
      ...
      accounts: [{ name: "allocated", isMut: true, isSigner: true }],
    },
  },
  accounts: { Account: { discriminator: [], fields: [] } },
  types: {},
  errors: {},
});
...
const instructionPayloadsJsonCodecs = {
  create: jsonCodecObjectToObject({
    lamports: jsonCodecBigInt,
    space: jsonCodecBigInt,
...
export const instructions = {
  ...
  assign: makeInstructionObject<
    { assigned: Pubkey },
    { assigned: Pubkey },
    { assigned: Pubkey },
    JsonCodecContent<(typeof instructionPayloadsJsonCodecs)["assign"]>,
    JsonCodecContent<(typeof instructionResultsJsonCodecs)["assign"]>
  >(
    "assign",
    instructionPayloadsJsonCodecs["assign"],
    instructionResultsJsonCodecs["assign"],
  ),
  transfer: makeInstructionObject<
    { payer: Pubkey; receiver: Pubkey },
    { payer: Pubkey; receiver: Pubkey },
    { payer: Pubkey; receiver: Pubkey },
  ...
  allocate: makeInstructionObject<
    { allocated: Pubkey },
    { allocated: Pubkey },
    { allocated: Pubkey },
    JsonCodecContent<(typeof instructionPayloadsJsonCodecs)["allocate"]>,
    JsonCodecContent<(typeof instructionResultsJsonCodecs)["allocate"]>
  >(
    "allocate",
    instructionPayloadsJsonCodecs["allocate"],
    instructionResultsJsonCodecs["allocate"],
  ),
};
