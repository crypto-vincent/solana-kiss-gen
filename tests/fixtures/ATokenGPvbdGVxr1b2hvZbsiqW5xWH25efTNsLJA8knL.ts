import {idlProgramParse,pubkeyFromBase58,jsonCodecConst,JsonCodecContent,Solana,Pubkey,JsonCodec,InstructionRequest,IdlInstructionAddresses,idlInstructionAccountsEncode,idlInstructionArgsEncode,idlInstructionReturnDecode,jsonCodecPubkey,jsonCodecObjectToObject,JsonValue,idlPdaFind} from "solana-kiss";
...
export const metadata = {
  ...
  "source":new URL("https://raw.githubusercontent.com/crypto-vincent/solana-idls/refs/heads/main/data/ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL.json"),
  "version":undefined,
};
...
const pdasInputsJsonCodecs = {
  "ata":jsonCodecObjectToObject({owner:jsonCodecPubkey,tokenProgram:jsonCodecPubkey,mint:jsonCodecPubkey}),
};

export const pdas = {
  "ata":makePdaObject<JsonCodecContent<typeof pdasInputsJsonCodecs["ata"]>>("ata",pdasInputsJsonCodecs["ata"]),
};
